...
# 프로젝트 회고
>조민규
>- 소개 : 가치있는 개발, 사람들을 웃게 만드는 개발을 위해 항상 주저없이 배워가고 있습니다.
>- 회고 : 요구사항 명세서, 유스케이스 다이어그램, 논리/물리 모델링은 처음 해보는 경험이었습니다. 팀원들과 함께하니 extend/include, DB에 포함/제외할 특성, 식별/비식별 관계 등 의견을 맞춰나가야 할 부분이 많았습니다. 하지만 동시에, 혼자였으면 해내지 못할 분량을 모두와 함께했기에 진행할 수 있었습니다. 이후 프로젝트에서도 기획~모델링 과정은 포함될 것이기에, 반복하며 더 익숙해질 수 있도록 노력하겠습니다.

>정현호
>- 소개 : 항상 효율적인 방법을 고민하며, 더 나은 생산성을 추구하고자 합니다.
>- 회고 : 처음에는 구현만 어려울 줄 알았습니다. 하지만, 구현이 아닌 프로젝트를 진행하며 서로의 생각을 규합하는 과정이 굉장히 어렵다는 것을 깨달았습니다. 이를 통해 협업시 설계 과정에서 더 오랜 시간을 쏟는 다는 말을 한층 더 깊이 이해할 수 있게 되었습니다. 또한, 설계 과정시 최대한 긴 시간을 할애해야 구현 과정에서의 논리적 오류 해결을 최소화 시킬 수 있다는 것을 알았습니다. 다들 고생 많았던 것 같습니다.

>김선일
>- 소개 : 새로운 기술을 배우는 과정이 재미있고, 완성된 결과물이 눈앞에 나타날 때 큰 보람을 느낍니다. 앞으로도 계속해서 발전하며 더 좋은 개발자가 되고 싶습니다. 
>- 회고 : SW공학, 데이터베이스, 리눅스를 학습하고 처음으로 프로젝트를해서 부족한것도 많았지만 다음에는 잘 할수 있도록 노력해야겠다.

>최현지
>- 소개 : 새로운 경험을 통해 발전해나가고, 사람들과의 소통을 통해 더 좋은 방향으로 나아가겠습니다.
>- 회고 : 프로젝트를 시작하면서 프로젝트 기획, 요구사항 명세서, 유스케이스 다이어그램, DB 설계, 구현하는 것까지 쉽지 않은 일이었지만 팀원분들과 같이 하면서 데이터베이스 구조에 대해서 전반적으로 이해할 수 있었습니다. 또한, 기획부터 설계까지 많은 소통과 협업이 필요하다는 것을 깨달았습니다. 이해한 내용을 바탕으로 다음 프로젝트에 유용하게 반영하고 협업도 더 적극적으로 참여해야겠다고 느꼈습니다.